function openModal() {
    ...
    confirmMyInput.onkeyup = function () {
        ...
        var passEqualsConfPass = document.getElementById("cpsw").value === document.getElementById("psw").value; // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
